...
<body ng-app="">
<h3 style="font-size: 13px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; color: #135cae; text-align:left;"><u>Step 1:</u></h3><form name="busCardInfo" ng-init="fName='Jason'">
<table width="1036" style="border:medium, #06C; width:1125px; height:60px;">
  <tr>
    <td width="94" height="22"><label>First Name:</label></td><td width="274"><input type="text" name="fName" ng-model="fName" ng-required="true"></td>
    <td width="212">&nbsp;</td>
    <td width="430">&nbsp;</td>
  </tr>
  <tr>
    <td height="22"><label>Last Name:</label></td><td><input name="lName" type="text" ng-model="lName" ng-required="true"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
    </tr>
  <tr>
    <td height="22"><label>Title:</label></td><td><input name="title" type="text" ng-model="title" ng-required="false"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
 </table></form> 
 <table><tr><td width="80" height="35"><button ng-model="boldButton" ng-style="text-decoration:bold;" id="boldButton">Bold</button></td><td width="110"><button ng-model="underlineButton" id="underlineButton">Underline</button></td><td width="913"><button ng-model="italicButton" id="italicButton">Italic</button></td></tr></table>
...
<img ng-src="/DesignSuite/{{pictureUpload}}.png" width="200" height="250">
<div style="position: relative; width: 718px; left: 230px; height: 290px; top: -250px;">{{ fName }} {{lName}}<br/>{{title}}<br/><p>{{address1}}<br/>if(address2 != null)
	{{address2}}
<br/>{{city}}, {{state}} {{postal_code}}<br/><br/>{{phone}}<br/>{{email}}</div>
</div>
</form>
</div>
