...
import chessgame.model.piecesFactory.Bishop;
import chessgame.model.piecesFactory.King;
import chessgame.model.piecesFactory.Knight;
import chessgame.model.piecesFactory.Pawn;
import chessgame.model.piecesFactory.Piece;
import chessgame.model.piecesFactory.Queen;
import chessgame.model.piecesFactory.Rook;
import chessgame.model.player.BlackPlayer;
import chessgame.model.player.Player;
import chessgame.model.player.WhitePlayer;
...
public final class Board {
    ...
    public String toString() {
        ...
        for (int i = 0; i < BoardUtils.NUM_TILES; i++) {
            final String tileText = printBoard(this.gameBoard.get(i));
