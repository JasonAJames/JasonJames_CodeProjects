...
import chessgame.model.piecesFactory.Pawn;
...
public abstract class Move {
    ...
    public Board execute() {
        ...
        /* Represents moved piece after it has been moved */
    ...
    public static final class PawnJumpMove extends Move {
        ...
        public PawnJumpMove(final Board board, final Pawn movedPiece, final int destinationCoordinate) {
            super(board, movedPiece, destinationCoordinate);
        }
    ...
    public static final class KingSideCastleMove extends CastleMove {
        ...
        // PGN - (Portable Game Notation) Convention for returning King Side Castle
        @Override
        public String toString() {
            return "O-O";
        }
    ...
    public static final class QueenSideCastleMove extends CastleMove {
        ...
        // PGN - (Portable Game Notation) Convention for returning Queen Side Castle
        @Override
        public String toString() {
            return "O-O-O";
        }
    ...
    public static final class InvalidMove extends Move {
        ...
        @Override
        public Board execute() {
            throw new RuntimeException("Can not execute. The Move is Invalid!");
        }
    ...
    public static class MoveFactory {
        private MoveFactory() {
            throw new RuntimeException("Can not instantiate this Move Factory class!");
        }
